    ...
    with open(filename, 'rU') as csvfile:
        ...
        for row in reader:
            ...
            for entity in data['entities']:
                #print(' 11  '+entity['mention'])
                if ('Airtel' in entity['mention'])  or ('airtel' in entity['mention'] ):
...
if __name__ == '__main__':
    ...
    #extractUrl()
    key2='9993f062988b012b714289e2853900e5'
    finalResult = extractUrl(ARGS,key2)
