        ...
        for year in range(2012, 2020):
            ...
            for month in range(1, 2):
                ...
                for days in range(1, 32):
                    ...
                    yield self.make_requests_from_url('https://www.reuters.com/finance/stocks/company-news/BRTI.NS?date=%s%s%s'% (m, d, y))

    def parse(self, response):
        NEWS_SELECTOR = 'a' #grab all news
        items= []
